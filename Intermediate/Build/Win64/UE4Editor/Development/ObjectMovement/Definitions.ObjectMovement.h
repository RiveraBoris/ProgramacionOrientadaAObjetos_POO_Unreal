...
#define UE_PROJECT_NAME ObjectMovement
#define UE_TARGET_NAME ObjectMovementEditor
#define UE_MODULE_NAME "ObjectMovement"
...
#define OBJECTMOVEMENT_API DLLEXPORT
